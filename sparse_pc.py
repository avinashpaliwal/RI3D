...
def pipeline(scene, base_path, n_views):
    ...
    res = os.popen( 'colmap feature_extractor --database_path database.db --image_path images').read()
    os.system( 'colmap exhaustive_matcher --database_path database.db --SiftMatching.guided_matching 1 --SiftMatching.max_num_matches 65535')
