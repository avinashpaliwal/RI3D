...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            try:
                num_rendered, color, depth, alpha, radii, geomBuffer, binningBuffer, imgBuffer, gs_w = _C.rasterize_gaussians(*args)
        ...
        return color, radii, depth, alpha, gs_w

    @staticmethod
    def backward(ctx, grad_color, grad_radii, grad_depth, grad_alpha, grad_gs_w):
