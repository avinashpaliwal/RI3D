...
def set_scenegraph_options(inputfiles, win_cyclic, refid, scenegraph_type):
    ...
    if scenegraph_type in ["swin", "logwin"]:
        ...
        winsize = gradio.Slider(label="Scene Graph: Window Size", value=max_winsize,
                                minimum=min_winsize, maximum=max(min_winsize + 1, max_winsize), step=1, visible=True)
        ...
        winsize = gradio.Slider(label="Retrieval: Num. key images", value=min(20, num_files),
                                minimum=0, maximum=max(1, num_files), step=1, visible=True)
        win_cyclic = gradio.Checkbox(visible=False)
        refid = gradio.Slider(label="Retrieval: Num neighbors", value=min(max(1, num_files - 1), 10), minimum=1,
                              maximum=max(2, num_files - 1), step=1, visible=True)
        ...
        refid = gradio.Slider(label="Scene Graph: Id", value=0, minimum=0,
                              maximum=max(1, num_files - 1), step=1, visible=True)
                    ...
                    with gradio.Row():
                        ...
                        with gradio.Column(visible=False) as graph_opt:
                            ...
                            refid = gradio.Slider(label="Scene Graph: Id", value=0,
                                                  minimum=0, maximum=100, step=1, visible=False)
