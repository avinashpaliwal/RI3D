...
from scene.dataset_readers_flow import sceneLoadTypeCallbacks
...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, shuffle=False, resolution_scales=[1.0], extra_opts=None, load_ply=None):
        ...
        if self.loaded_iter:
            ...
            self.gaussians.create_from_pcd(scene_info.point_cloud, self.cameras_extent, self.train_cameras[1.0], flows)
